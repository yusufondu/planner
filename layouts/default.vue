  ...
  <v-app>
    <v-main>
      ...
      <div class="d-block">
        <v-row
          align="center"
          class="justify-space-between d-flex pt-3 pl-4 pr-5 blue lighten-2 align-center"
        >
          ...
          <v-col class="d-flex justify-center align-center">
            <nuxt-link to="/">
              <h3 class="logo">Planner</h3>
            </nuxt-link>
          </v-col>
          <v-col class="d-flex justify-end align-center">
            <nuxt-link to="/auth/signout">
              <v-icon>mdi-exit-to-app</v-icon>&nbsp;
              <span style="color: #424242">Sign out</span>
            </nuxt-link>
          </v-col>
        </v-row>
        <v-navigation-drawer v-model="drawer" fixed left class="d-block">
          <v-container fluid class="planner-topbar">
